...
namespace Proxy::ExecutionModes
{
    ...
    (int32_t& socketForForwarding, int32_t destinationPort, const std::string& hostName) noexcept
    {
    ...
    Utilities::Status ExecutionMode::CreateForwardingSocketByIP
            (int32_t& socketForForwarding, int32_t destinationPort, const std::string& addr) noexcept
    {
        Utilities::Status status {};
    ...
    (int32_t& listeningSocket, int32_t listeningPort, sockaddr_in& socketData) noexcept
    {
        Utilities::Status status {};
...
//                    status = Utilities::Status::Success::IgnoredBadConnectionHostDomainName;
    ...
    (const char* buffer, uint32_t offset) noexcept
    {
...
//        memcpy(domainName,buffer + Utilities::Offsets::TLS::SNI - offset, domainNameSize);
    ...
    (const char* buff, int32_t offset) noexcept
    {
    ...
    void ExecutionMode::PrintNetworkData
    (const char* buffer, uint32_t size) noexcept
    {
        printf("=============");
    ...
    uint16_t ExecutionMode::GetUint16FromNetworkData(const char* buff) noexcept
    {
        uint16_t tmpValue {};
    ...
    uint32_t ExecutionMode::GetUint32FromNetworkData(const char* buff) noexcept
    {
        uint32_t tmpValue {};
