...
//        const char buf[2] ={0x00,0x00};
//        const char buf1[2] ={0x00,0x02};
//        const char buf2[2] ={0x00,0x03};
//        const char buf3[2] ={0x00,static_cast<char>(0xFE)};
//
...
//        const char buf[2] = {0x00, 0x01};
//        const char buf1[2] = {0x00, static_cast<char>(0xFF)};
//
